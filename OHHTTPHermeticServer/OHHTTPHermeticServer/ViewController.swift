...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        */
        ...
        //OHHTTPManager.sharedInstance.startHermeticServerJSONWithContainsURL("q=Aladin", pathForFile: "Tomorrowland.json", statusCode: 200, downloadSpeed:DownloadSpeedEDGE)
